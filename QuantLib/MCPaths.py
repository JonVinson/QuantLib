...
class SABRPaths(MCPaths):
    ...
    def __init__(self, n_paths = 0, n_steps = 0, mu = 0.0, alpha = 0.0, beta = 1.0, rho = 0.0, f0 = 0.0, sig0 = 0.0, dt = 1.0, Z1 = None, Z2 = None):
        self.X = None
        self.Y = None
        self.Z = None
        self.mu = mu
        ...
        self.dt = dt
        if n_paths > 0 and n_steps > 0:
            (self.X, self.Y, self.Z) = sabr(n_paths, n_steps, mu, alpha, beta, rho, f0, sig0, dt, Z1, Z2)
